@echo off
REM ========================================================================
REM Krypton Extended Toolkit - Quick Build Script (Nightly)
REM 
REM This script builds the Nightly configuration of the toolkit.
REM Nightly builds are alpha releases with -alpha package suffix.
REM ========================================================================

echo.
echo ========================================================================
echo   Krypton Extended Toolkit - Building Nightly Configuration (Alpha)
echo ========================================================================
echo.
...
if %ERRORLEVEL% == 0 (
    ...
    echo.
    echo Package suffix: -alpha
    echo Target branch: alpha
    echo.
) else (
    echo.
    echo ========================================================================
