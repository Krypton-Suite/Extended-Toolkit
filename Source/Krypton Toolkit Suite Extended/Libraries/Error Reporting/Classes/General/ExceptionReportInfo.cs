...
namespace Krypton.Toolkit.Suite.Extended.Error.Reporting
{
    ...
    public class ExceptionReportInfo
    {
        ...
        public string TitleText { get; set; } = Strings.ErrorReport;
    ...
    internal static class DefaultLabelMessages
    {
        ...
        public static readonly string DefaultExplanationLabel =
            Strings.Please_enter_a_brief_explanation_of_events_leading_up_to_this_exception;
        ...
        public static readonly string DefaultContactMessageTop =
            Strings.The_following_details_can_be_used_to_obtain_support_for_this_application;
    }
}
