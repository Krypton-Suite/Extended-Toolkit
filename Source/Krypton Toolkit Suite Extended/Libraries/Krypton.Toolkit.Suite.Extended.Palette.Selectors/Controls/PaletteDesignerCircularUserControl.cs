...
namespace Krypton.Toolkit.Suite.Extended.Palette.Selectors
{
    public class PaletteDesignerCircularUserControl : UserControl
    {
        ...
        #region Custom Event
        public delegate void ColourValuesChangedEventHandler(CacheVirtualItemsEventArgs e);

        public event CollectionChangeEventHandler ColourValuesChanged;
        #endregion
        ...
        {
            SetupColourToolTips(_showColourInformation);
