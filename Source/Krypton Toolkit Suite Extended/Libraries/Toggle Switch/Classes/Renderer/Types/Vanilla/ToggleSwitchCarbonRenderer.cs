...
namespace Krypton.Toolkit.Suite.Extended.Toggle.Switch.Classes
{
        ...
        public override void RenderButton(Graphics g, Rectangle buttonRectangle)
        {
            ...
            using (GraphicsPath buttonPath = GetRoundedRectanglePath(buttonRectangle, CornerRadius))
            {
                ...
                if (buttonImage != null)
                {
                    ...
                    KryptonToggleSwitch.ToggleSwitchButtonAlignment alignment = ToggleSwitch.ButtonImage != null ? ToggleSwitch.ButtonAlignment : (ToggleSwitch.Checked ? ToggleSwitch.OnButtonAlignment : ToggleSwitch.OffButtonAlignment);
