...
namespace Krypton.Toolkit.Suite.Extended.Data.Visualisation
{
    ...
    public class HBarChart : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "HBarChart";
            this.Paint += new System.Windows.Forms.PaintEventHandler(this.HBarChart_Paint);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.HBarChart_MouseMove);
            this.Resize += new System.EventHandler(this.HBarChart_Resize);
        ...
        */
        ...
        private void DrawBackground(Graphics gr, Bitmap bmpChart)
        {
            if (Background.PaintingMode == CBackgroundProperty.PaintingModes.LinearGradient)
            {
                LinearGradientBrush br = new LinearGradientBrush(
                    ...
                    Background.GradientColour1, Background.GradientColour2);

                gr.FillRectangle(br, new Rectangle(0, 0, bmpChart.Width, bmpChart.Height));
            }
            else if (Background.PaintingMode == CBackgroundProperty.PaintingModes.SolidColour)
            {
                gr.FillRectangle(new SolidBrush(Background.SolidColour), new Rectangle(0, 0, bmpChart.Width, bmpChart.Height));
            }
            else
            {
                gr.FillRectangle(new SolidBrush(Background.SolidColour), new Rectangle(0, 0, bmpChart.Width, bmpChart.Height));
        ...
        private Color GetDarkerColour(Color color, byte intensity)
        {
            int r, g, b;
        ...
        private void HBarChart_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void HBarChart_Resize(object sender, EventArgs e)
        {
            RedrawChart();
        }

        private void HBarChart_MouseMove(object sender, MouseEventArgs e)
        {
