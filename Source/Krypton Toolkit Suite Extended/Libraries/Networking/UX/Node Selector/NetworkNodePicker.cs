...
{
    public class NetworkNodePicker : KryptonForm
    {
        #region Design Code
        ...
        internal void DisplayComputerTypes(uint serverType)
        {
            ...
            if (_computerEnum.LastError.Length == 0)
            {
                ...
                KryptonMessageBoxExtended.Show(this, "Error \"" + _computerEnum.LastError + "\"was returned", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
