...
namespace Krypton.Toolkit.Suite.Extended.IO
{
    ...
    public partial class FastColouredTextBox : UserControl, ISupportInitialize
    {
        ...
        private FastColouredTextBox sourceTextBox;
        ...
        public FastColouredTextBox()
        {
            ...
            AcceptsReturn = true;
            caretVisible = true;
            CaretColour = Color.Black;
            WideCaret = false;
            Paddings = new Padding(0, 0, 0, 0);
            PaddingBackColour = Color.Transparent;
...
^\s*(case|default)\s*[^:]*(?<range>:)\s*(?<range>[^;]+);";
            ...
            CaretBlinking = true;
            ServiceColours = new ServiceColors();
            //
        ...
        /// </summary>
        [Browsable(true)]
        [Description("Colours of some service visual markers.")]
        ...
        [Description("Colour of bookmarks.")]
        public Color BookmarkColour { get; set; }
        ...
        [Description("Colour of border of text area")]
        public Color TextAreaBorderColour
        {
        ...
        [Description("Background colour for current line. Set to Color.Transparent to hide current line highlighting")]
        ...
        /// </summary>
        [DefaultValue(typeof(Color), "Transparent")]
        [Description("Background colour for highlighting of changed lines. Set to Color.Transparent to hide changed line highlighting")]
        public Color ChangedLineColour
        {
        ...
        [Description("Colour of line numbers.")]
        ...
        [Description("Background colour of indent area")]
        public Color IndentBackColour
        {
        ...
        /// </summary>
        [DefaultValue(typeof(Color), "Transparent")]
        [Description("Background colour of padding area")]
        public Color PaddingBackColour
        {
        ...
        [Description("Colour of disabled component")]
        ...
        /// </summary>
        [DefaultValue(typeof(Color), "Black")]
        [Description("Colour of caret.")]
        public Color CaretColour { get; set; }
        ...
        [Description("Colour of service lines (folding lines, borders of blocks etc.)")]
        public Color ServiceLinesColour
        {
        ...
        [Description("Colour of folding area indicator.")]
        public Color FoldingIndicatorColour
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (iLine = startLine; iLine < lines.Count; iLine++)
            {
                ...
                if (ShowLineNumbers)
                {
                    ...
                    using (var lineNumberBrush = new SolidBrush(LineNumberColour))
            ...
            if ((startFoldingLine >= 0 || endFoldingLine >= 0) && Selection.Start == Selection.End)
                if (endFoldingLine < LineInfos.Count)
                {
                    ...
                    using (var indicatorPen = new Pen(Color.FromArgb(100, FoldingIndicatorColour), 4))
            ...
            if ((Focused || IsDragDrop || ShowCaretWhenInactive) && car.X >= LeftIndent && CaretVisible)
            {
                ...
                if (WideCaret)
                {
                    using (var brush = new SolidBrush(CaretColour))
                        e.Graphics.FillRectangle(brush, car.X, car.Y, carWidth, caretHeight + 1);
                }
                else
                    using (var pen = new Pen(CaretColour))
            ...
            //draw disabled mask
            if (!Enabled)
                using (var brush = new SolidBrush(DisabledColour))
        ...
        private void DrawMarkers(PaintEventArgs e, Pen servicePen)
        {
            foreach (VisualMarker m in visibleMarkers)
            {
                if (m is CollapseFoldingMarker)
                    using (var bk = new SolidBrush(ServiceColours.CollapseMarkerBackColor))
                    using (var fore = new Pen(ServiceColours.CollapseMarkerForeColor))
                    using (var border = new Pen(ServiceColours.CollapseMarkerBorderColor))
                        (m as CollapseFoldingMarker).Draw(e.Graphics, border, bk, fore);
                else
                if (m is ExpandFoldingMarker)
                    using (var bk = new SolidBrush(ServiceColours.ExpandMarkerBackColor))
                    using (var fore = new Pen(ServiceColours.ExpandMarkerForeColor))
                    using (var border = new Pen(ServiceColours.ExpandMarkerBorderColor))
        ...
        {
            e.Graphics.SmoothingMode = SmoothingMode.None;
            using (var pen = new Pen(Color.FromArgb(200, ServiceLinesColour)) { DashStyle = DashStyle.Dot })
