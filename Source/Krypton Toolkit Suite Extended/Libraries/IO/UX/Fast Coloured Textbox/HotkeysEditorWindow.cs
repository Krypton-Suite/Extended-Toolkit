...
namespace Krypton.Toolkit.Extended.IO
{
    public class HotkeysEditorWindow : KryptonForm
    {
        ...
        private KryptonDataGridViewComboBoxColumn colAction;
        ...
        private void InitializeComponent()
        {
            ...
            this.colAction = new Krypton.Toolkit.KryptonDataGridViewComboBoxColumn();
            ...
            this.colAction.DataSource = null;
            this.colAction.DropDownWidth = 121;
            this.colAction.HeaderText = "Action";
            this.colAction.Name = "colAction";
            this.colAction.Width = 466;
            // 
            // kbtnAdd
            // 
        ...
        {
            for (int i = kdgv.RowCount - 1; i >= 0; i--)
            {
                if (kdgv.Rows[i].Selected)
                {
                    kdgv.Rows.RemoveAt(i);
                }
            }
        }
