...
namespace Krypton.Toolkit.Extended.IO
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        protected FastColouredTextBox currentTb;
        ...
        public SyntaxHighlighter(FastColouredTextBox currentTb)
        {
        ...
        {
            var tb = (sender as FastColouredTextBox);
        ...
        protected void RestoreBrackets(FastColouredTextBox tb, char[] oldBrackets)
        {
        ...
        protected char[] RememberBrackets(FastColouredTextBox tb)
        {
