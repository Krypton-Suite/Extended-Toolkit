...
namespace Krypton.Toolkit.Suite.Extended.Task.Dialogs
{
    ...
    public sealed class TaskDialogStandardButton : TaskDialogButton
    {
        ...
        public TaskDialogStandardButton(TaskDialogResult result) : base()
        {
        ...
        internal new TaskDialogStandardButtonCollection Collection { get => (TaskDialogStandardButtonCollection)base.Collection; set => base.Collection = value; }
        ...
        private static bool IsValidStandardButtonResult(TaskDialogResult result) => GetButtonFlagForResult(result) != default;
