...
namespace Krypton.Toolkit.Suite.Extended.Base
{
    ...
    public class KryptonMessageBoxExtendedExperimental : KryptonForm //Extended
    {
        ...
        private void InitialiseComponent()
        {
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "KryptonMessageBoxExtendedExperimental";
            ShowIcon = false;
            ShowInTaskbar = false;
        ...
        #region Constructors
        static KryptonMessageBoxExtendedExperimental() => _osMajorVersion = Environment.OSVersion.Version.Major;
                                                 ...
                                                 Font messageboxTypeface = null)
        {
            ...
            using (KryptonMessageBoxExtendedExperimental ekmb = new KryptonMessageBoxExtendedExperimental(showOwner, text, caption, buttons, icon, defaultButton, options, helpInformation, showCtrlCopy, messageboxTypeface))
            {
