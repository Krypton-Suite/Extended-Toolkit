...
namespace Krypton.Toolkit.Extended.Base
{
    ...
    public class ToggleSwitch : Control
    {
        ...
        private ToggleSwitchStyle _style = ToggleSwitchStyle.KRYPTONSTANDARD;
        ...
        private ToggleSwitchButtonAlignment _buttonAlignment = ToggleSwitchButtonAlignment.CENTRE;
        ...
        private ToggleSwitchAlignment _offSideAlignment = ToggleSwitchAlignment.CENTRE;
        private Image _offButtonImage = null;
        private bool _offButtonScaleImage;
        private ToggleSwitchButtonAlignment _offButtonAlignment = ToggleSwitchButtonAlignment.CENTRE;
        ...
        private ToggleSwitchAlignment _onSideAlignment = ToggleSwitchAlignment.CENTRE;
        private Image _onButtonImage = null;
        private bool _onButtonScaleImage;
        private ToggleSwitchButtonAlignment _onButtonAlignment = ToggleSwitchButtonAlignment.CENTRE;
        #endregion

        #region Construtor
        public ToggleSwitch()
        {
            SetStyle(ControlStyles.ResizeRedraw | ControlStyles.UserPaint | ControlStyles.AllPaintingInWmPaint | ControlStyles.OptimizedDoubleBuffer | ControlStyles.DoubleBuffer | ControlStyles.SupportsTransparentBackColor, true);

            OnTypeface = base.Font;

            OffTypeface = base.Font;

            SetRenderer(new ToggleSwitchKryptonRenderer());
        ...
        [Bindable(false)]
        [DefaultValue(typeof(ToggleSwitchStyle), "KRYPTONSTANDARD")]
        [Category("Appearance")]
                ...
                if (value != _style)
                {
                    ...
                    switch (_style)
                    {
                        ...
                        case ToggleSwitchStyle.IOS:
                            SetRenderer(new ToggleSwitchIOSRenderer());
                            break;
                        ...
                        case ToggleSwitchStyle.MODERN:
                            ...
                            break;
                        case ToggleSwitchStyle.KRYPTONBRUSHEDMETAL:
                            SetRenderer(new ToggleSwitchKryptonBrushedMetalRenderer());
                            break;
                        case ToggleSwitchStyle.KRYPTONSTANDARD:
                            SetRenderer(new ToggleSwitchKryptonRenderer());
                            break;
        ...
        protected override void OnPaintBackground(PaintEventArgs pevent)
        {
            ...
            if (_renderer != null) _renderer.RenderBackground(pevent);
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_renderer != null)
            {
                if (RendererChanged != null) RendererChanged(this, new RendererChangedEventArgs(_renderer));
