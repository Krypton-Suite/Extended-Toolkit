...
{
    [DefaultValue("Checked"), DefaultEvent("CheckedChanged"), ToolboxBitmap(typeof(KryptonCheckBox)), ToolboxItem(false)]
    public class KryptonToggleSwitch : Control
    {
        ...
        public delegate void BeforeRenderingDelegate(object sender, KryptonToggleSwitchRendererChangedEventArgs e);
        ...
        private KryptonToggleSwitchRendererBase _renderer;
        ...
        public KryptonToggleSwitch()
        {
            ...
            SetRenderer(new KryptonToggleSwitchMetroRenderer());
        ...
        public void SetRenderer(KryptonToggleSwitchRendererBase renderer)
        {
                ...
                if (value != _style)
                {
                    ...
                    switch (_style)
                    {
                        ...
                        case ToggleSwitchStyle.Android:
                            SetRenderer(new KryptonToggleSwitchAndroidRenderer());
                            break;
                        case ToggleSwitchStyle.IOS5:
                            SetRenderer(new KryptonToggleSwitchIOS5Renderer());
                            break;
                        case ToggleSwitchStyle.BrushedMetal:
                            SetRenderer(new KryptonToggleSwitchBrushedMetalRenderer());
                            break;
                        case ToggleSwitchStyle.OSX:
                            SetRenderer(new KryptonToggleSwitchOSXRenderer());
                            break;
                        case ToggleSwitchStyle.Carbon:
                            SetRenderer(new KryptonToggleSwitchCarbonRenderer());
                            break;
                        case ToggleSwitchStyle.Iphone:
                            SetRenderer(new KryptonToggleSwitchIphoneRenderer());
                            break;
                        case ToggleSwitchStyle.Fancy:
                            SetRenderer(new KryptonToggleSwitchFancyRenderer());
                            break;
                        case ToggleSwitchStyle.Modern:
                            SetRenderer(new KryptonToggleSwitchModernRenderer());
                            break;
                        case ToggleSwitchStyle.PlainAndSimple:
                            SetRenderer(new KryptonToggleSwitchPlainAndSimpleRenderer());
                            break;
                    }
                }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_renderer != null)
            {
                ...
                {
                    BeforeRendering(this, new KryptonToggleSwitchRendererChangedEventArgs(_renderer));
                }
