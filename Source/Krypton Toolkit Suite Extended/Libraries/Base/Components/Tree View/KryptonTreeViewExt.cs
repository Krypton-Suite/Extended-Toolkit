...
namespace Krypton.Toolkit.Suite.Extended.Base
{
    ...
    public class KryptonTreeViewExt : TreeView
    {
        ...
        Color _gradientStartColorTmp = Color.White;
        ...
        Color _gradientEndColorTmp = Color.Gray;
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Browsable(true), Category("Appearance-Extended")]
        ...
        Color _gradientStartColorStyled = Color.White;
        [Browsable(true), Category("Appearance-Extended")]
        [DefaultValue("Color.White")]
        ...
        Color _gradientEndColorStyled = Color.Gray;
        [Browsable(true), Category("Appearance-Extended")]
        [DefaultValue("Color.Gray")]
        ...
        Color _gradientStartColorLostFocus = Color.WhiteSmoke;
        [Browsable(true), Category("Appearance-Extended")]
        ...
        Color _gradientEndColorLostFocus = Color.LightGray;
        [Browsable(true), Category("Appearance-Extended")]
        ...
        public Boolean PersistentColors
        {
            ...
            set { _persistentColors = value; InitColors(); Invalidate(); }
        }
        ...
        public Boolean UseStyledColours
        {
            ...
            set { _useStyledColors = value; InitColors(); Invalidate(); }
        }
        ...
        Color _flatDesignColor = Color.Gray;
        Color _flatDesignColorTmp = Color.Gray;
        [Browsable(true), Category("Appearance-Extended")]
        ...
        Color _nodeTextColor = Color.Gray;
        Color _nodeTextColorTmp = Color.Gray;
        [Browsable(true), Category("Appearance-Extended")]
        ...
        Color _nodeFocusColor = Color.Gray;
        [Browsable(true), Category("Appearance-Extended")]
        ...
        Color _flatDesignColorLostFocus = Color.FromArgb(231, 231, 231);
        [Browsable(true), Category("Appearance-Extended")]
