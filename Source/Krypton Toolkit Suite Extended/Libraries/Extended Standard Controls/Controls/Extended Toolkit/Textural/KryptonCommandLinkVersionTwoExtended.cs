...
namespace ExtendedStandardControls.Controls.ExtendedToolkit.Textural
{
    public class KryptonCommandLinkVersionTwoExtended : KryptonCommandLinkVersion2
    {
        #region Variables
        ...
        #region Constructor
        public KryptonCommandLinkVersionTwoExtended()
        {
