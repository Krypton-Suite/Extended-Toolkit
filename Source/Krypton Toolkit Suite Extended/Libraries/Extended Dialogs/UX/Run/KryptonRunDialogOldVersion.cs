...
{
    public class KryptonRunDialogOldVersion : KryptonForm
    {
        #region Design Code
    ...
    "s will open it for you.";
        ...
        #region Constructors
        /// <summary>Initializes a new instance of the <see cref="KryptonRunDialogOldVersion"/> class.</summary>
        /// <param name="type">The input type.</param>
        /// <param name="iconVisibility">The icon visibility.</param>
        /// <param name="showUACRunButton"></param>
        public KryptonRunDialogOldVersion(RunDialogType type = RunDialogType.TEXTBOX, RunDialogIconVisibility iconVisibility = RunDialogIconVisibility.VISIBLE, bool showUACRunButton = false)
        {
            InitializeComponent();
