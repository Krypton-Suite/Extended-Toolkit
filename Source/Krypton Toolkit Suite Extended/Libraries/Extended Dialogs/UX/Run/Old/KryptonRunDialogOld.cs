...
{
    public class KryptonRunDialogOld : KryptonForm
    {
        #region Design Code
    ...
    "s will open it for you.";
        ...
        #region Constructors
        /// <summary>Initializes a new instance of the <see cref="KryptonRunDialogOld"/> class.</summary>
        /// <param name="type">The input type.</param>
        /// <param name="iconVisibility">The icon visibility.</param>
        public KryptonRunDialogOld(Type type = Type.TEXTBOX, IconVisibility iconVisibility = IconVisibility.VISIBLE)
        {
            InitializeComponent();
