...
namespace Krypton.Toolkit.Suite.Extended.Navigator
{
    ...
    public class KryptonTabControlVersion2 : TabControl
    {
        ...
        static KryptonTabControlVersion2()
        {
        ...
        public KryptonTabControlVersion2()
        {
    ...
    public class KryptonTabControlDesigner : ParentControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new KryptonTabControlActionList(this.Component));
                return actionLists;
            }
        }
