...
namespace Krypton.Toolkit.Suite.Extended.Outlook.Grid
{
    ...
    public class OutlookGridGroupHelpers
    {
        ...
        public static string GetDayText(DateTime date)
        {
            ...
            {
                case "NODATE":
                    return LanguageManager.Instance.GetLocalisedString("NODATE");// "Today";
                case "TODAY":
                    return LanguageManager.Instance.GetLocalisedString("TODAY");// "Today";
                case "YESTERDAY":
                    return LanguageManager.Instance.GetLocalisedString("YESTERDAY");//"Yesterday";
                case "TOMORROW":
                    return LanguageManager.Instance.GetLocalisedString("TOMORROW");//"Tomorrow";
                case "Monday":
                case "Tuesday":
                case "Wednesday":
                case "Thursday":
                ...
                case "NEXTWEEK":
                    return LanguageManager.Instance.GetLocalisedString("NEXTWEEK");//"Next Week";
                case "INTWOWEEKS": //dans le deux semaines a venir
                    return LanguageManager.Instance.GetLocalisedString("INTWOWEEKS");//"In two weeks"; //dans le deux semaines a venir
                case "INTHREEWEEKS": //dans les trois semaines à venir
                    return LanguageManager.Instance.GetLocalisedString("INTHREEWEEKS");//"In three weeks"; //dans les trois semaines à venir
                case "LATERDURINGTHISMONTH": //Plus tard au cours de ce mois 
                    return LanguageManager.Instance.GetLocalisedString("LATERDURINGTHISMONTH");//"Later during this month"; //Plus tard au cours de ce mois 
                case "NEXTMONTH": //Prochain mois
                    return LanguageManager.Instance.GetLocalisedString("NEXTMONTH");//"Next month"; //Prochain mois
                case "AFTERNEXTMONTH":  //Au-delà du prochain mois 
                    return LanguageManager.Instance.GetLocalisedString("AFTERNEXTMONTH");//"After next month";  //Au-delà du prochain mois 
                case "PREVIOUSWEEK":
                    return LanguageManager.Instance.GetLocalisedString("PREVIOUSWEEK");//"Previous Week";
                case "TWOWEEKSAGO": //Il y a deux semaines
                    return LanguageManager.Instance.GetLocalisedString("TWOWEEKSAGO");//"Two weeks ago"; //Il y a deux semaines
                case "THREEWEEKSAGO": //Il y a deux semaines
                    return LanguageManager.Instance.GetLocalisedString("THREEWEEKSAGO");//"Three weeks ago"; //Il y a deux semaines
                case "EARLIERDURINGTHISMONTH": //Il y a deux semaines
                    return LanguageManager.Instance.GetLocalisedString("EARLIERDURINGTHISMONTH");//"Earlier during this month";  //Plus tot au cours de ce mois
                case "PREVIOUSMONTH": //Il y a deux semaines
                    return LanguageManager.Instance.GetLocalisedString("PREVIOUSMONTH");//"Previous Month";  //Mois dernier
                case "BEFOREPREVIOUSMONTH":  //Mois dernier
                    return LanguageManager.Instance.GetLocalisedString("BEFOREPREVIOUSMONTH");//"Before Previous Month";   //Avant le mois dernier
                default:
        ...
        public static string GetQuarterAsString(DateTime dateTime)
        {
            ...
            {
                case 1:
                    return LanguageManager.Instance.GetLocalisedString("Q1");
                case 2:
                    return LanguageManager.Instance.GetLocalisedString("Q2");
                case 3:
                    return LanguageManager.Instance.GetLocalisedString("Q3");
                case 4:
                    return LanguageManager.Instance.GetLocalisedString("Q4");
                default:
                    return "";
            }
        }
