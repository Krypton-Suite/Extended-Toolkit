...
namespace Krypton.Toolkit.Suite.Extended.Outlook.Grid
{
    ...
    public static class ColorFormatting
    {
        ...
        private static Color Interpolate(double percent, params Color[] colours)
        {
            ...
            Color colourLeft = colours[left];
            Color colourRight = colours[right];

            double step = 1.0 / (colours.Length - 1);
            double percentRight = (percent - (left * step)) / step;
            double percentLeft = 1.0 - percentRight;
            return Color.FromArgb((byte)(colourLeft.A * percentLeft + colourRight.A * percentRight), (byte)(colourLeft.R * percentLeft + colourRight.R * percentRight), (byte)(colourLeft.G * percentLeft + colourRight.G * percentRight), (byte)(colourLeft.B * percentLeft + colourRight.B * percentRight));
        }
    }
}