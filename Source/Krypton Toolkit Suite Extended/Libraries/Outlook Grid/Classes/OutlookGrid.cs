    ...
    public partial class KryptonOutlookGrid : KryptonDataGridView
    {
        ...
        private void ShowColumnHeaderContextMenu(int columnIndex)
        {
            ...
            if (_menuItems == null)
            {
                ...
                _menuSortAscending = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("SORTASCENDING"), Properties.Resources.sort_az_ascending2, OnColumnSortAscending);
                _menuSortDescending = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("SORTDESCENDING"), Properties.Resources.sort_az_descending2, new EventHandler(OnColumnSortDescending));
                _menuClearSorting = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("CLEARSORTING"), Properties.Resources.sort_up_down_delete_16, new EventHandler(OnColumnClearSorting));
                ...
                _menuGroupByThisColumn = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("GROUP"), Properties.Resources.element, new EventHandler(OnGroupByThisColumn));
                _menuUngroupByThisColumn = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("UNGROUP"), Properties.Resources.element_delete, new EventHandler(OnUnGroupByThisColumn));
                _menuShowGroupBox = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("SHOWGROUPBOX"), null, new EventHandler(OnShowGroupBox));
                ...
                _menuBestFitColumn = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("BESTFIT"), null, new EventHandler(OnBestFitColumn));
                _menuBestFitAllColumns = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("BESTFITALL"), Properties.Resources.fit_to_size, new EventHandler(OnBestFitAllColumns));
                _menuSeparator3 = new KryptonContextMenuSeparator();
                _menuVisibleColumns = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("COLUMNS"), Properties.Resources.table2_selection_column, null);
                _menuGroupInterval = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("GROUPINTERVAL"));
                _menuSortBySummary = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("SORTBYSUMMARYCOUNT"), null, new EventHandler(OnSortBySummary));
                _menuSortBySummary.CheckOnClick = true;
                _menuSeparator5 = new KryptonContextMenuSeparator();
                _menuConditionalFormatting = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("CONDITIONALFORMATTING"), Properties.Resources.table_conditional_16, null);
                ...
                for (int i = 0; i < names.Length; i++)
                {
                    ...
                    it3 = new KryptonContextMenuItem(LanguageManager.Instance.GetStringGB("ClearRules"));
