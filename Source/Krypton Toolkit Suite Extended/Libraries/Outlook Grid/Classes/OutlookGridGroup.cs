...
namespace Krypton.Toolkit.Suite.Extended.Outlook.Grid
{
    ...
    public class OutlookGridDefaultGroup : IOutlookGridGroup
    {
        ...
        public virtual string Text
        {
            get
            {
                ...
                {
                    formattedValue = LanguageManager.Instance.GetStringGB("UNKNOWN");
                }
    ...
    public class OutlookGridAlphabeticGroup : OutlookGridDefaultGroup
    {
        ...
        public override string Text
        {
            get
            {
                //return string.Format("{0}: {1} ({2})", LanguageManager.Instance.GetStringGB("AlphabeticGroupText"), Value.ToString(), itemCount == 1 ? LanguageManager.Instance.GetStringGB("OneItem") : itemCount.ToString() + LanguageManager.Instance.GetStringGB("XXXItems"));
            ...
            set
            {
                switch (Interval)
                {
                    ...
                    case DateInterval.YEAR:
                        ...
                        {
                            valDateTime = DateTime.MinValue;
                            val = LanguageManager.Instance.GetStringGB("NODATE");
                        }
                        break;
