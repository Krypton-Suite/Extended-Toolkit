...
namespace Krypton.Toolkit.Suite.Extended.Fast.Coloured.Text.Box
{
    ...
    public partial class FastColouredTextBox : UserControl, ISupportInitialize
    {
        ...
        private Color changedLineColour;
        ...
        private Color foldingIndicatorColour;
        ...
        private Hints hints;
        private Color indentBackColour;
        ...
        private Color lineNumberColour;
        ...
        private Color paddingBackColour;
        ...
        private Color serviceLinesColour;
...
^\s*(case|default)\s*[^:]*(?<range>:)\s*(?<range>[^;]+);";
        ...
        {
            get { return currentLineColour; }
            set
            {
                currentLineColour = value;
                Invalidate();
            }
        }
        ...
        {
            get { return changedLineColour; }
            set
            {
                changedLineColour = value;
                Invalidate();
            }
        }
        ...
        {
            get { return lineNumberColour; }
            set
            {
                lineNumberColour = value;
                Invalidate();
            }
        }
        ...
        {
            get { return indentBackColour; }
            set
            {
                indentBackColour = value;
                Invalidate();
            }
        }
        ...
        {
            get { return paddingBackColour; }
            set
            {
                paddingBackColour = value;
                Invalidate();
            }
        }
        ...
        {
            get { return serviceLinesColour; }
            set
            {
                serviceLinesColour = value;
                Invalidate();
            }
        }
        ...
        {
            get { return foldingIndicatorColour; }
            set
            {
                foldingIndicatorColour = value;
                Invalidate();
            }
        }
        ...
        {
            get { return selectionColour; }
            set
            {
                selectionColour = value;
                if (selectionColour.A == 255)
                    selectionColour = Color.FromArgb(60, selectionColour);
                SelectionStyle = new SelectionStyle(new SolidBrush(selectionColour));
                Invalidate();
            }
        }
