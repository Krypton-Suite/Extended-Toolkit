...
namespace Krypton.Toolkit.Suite.Extended.Task.Dialogs
{
    ...
    public abstract class TaskDialogButton : TaskDialogControl
    {
        ...
        private protected TaskDialogButton() : base()
        {
        }
        ...
        private protected IReadOnlyList<TaskDialogButton> Collection { get => _collection; set => _collection = value; }
        ...
        private protected void OnClick(TaskDialogButtonClickedEventArgs e) => Click?.Invoke(this, e);
