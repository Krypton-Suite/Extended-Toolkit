...
using TaskDialogButtonStruct = Krypton.Toolkit.Suite.Extended.Task.Dialogs.TaskDialogNativeMethods.TASKDIALOG_BUTTON;
using TaskDialogCallbackDelegate = Krypton.Toolkit.Suite.Extended.Task.Dialogs.TaskDialogNativeMethods.PFTASKDIALOGCALLBACK;
using TaskDialogConfig = Krypton.Toolkit.Suite.Extended.Task.Dialogs.TaskDialogNativeMethods.TASKDIALOGCONFIG;
...
using TaskDialogMessage = Krypton.Toolkit.Suite.Extended.Task.Dialogs.TaskDialogNativeMethods.TASKDIALOG_MESSAGES;
using TaskDialogNotification = Krypton.Toolkit.Suite.Extended.Task.Dialogs.TaskDialogNativeMethods.TASKDIALOG_NOTIFICATIONS;
