        ...
        public new bool CheckBoxes
        {
            ...
            set
            {
                ...
                if (this.VirtualMode)
                {
                    ...
                    // Change the KryptonCheckBox setting while not in virtual mode
...
#pragma warning restore 168
        ...
        protected virtual void CalculateStandardHitTest(OlvListViewHitTestInfo hti, int x, int y)
        {
            ...
            if (r.Contains(x, y))
            {
                ...
                {
                    hti.HitTestLocation = HitTestLocation.KryptonCheckBox;
                    return;
                }
                if (hasImage)
                {
        ...
        protected virtual bool ProcessLButtonDown(OlvListViewHitTestInfo hti)
        {
            ...
            if (hti.HitTestLocation != HitTestLocation.KryptonCheckBox)
                return false;
        ...
        protected virtual bool ProcessRButtonDown(OlvListViewHitTestInfo hti)
        {
            ...
            return (hti.HitTestLocation == HitTestLocation.KryptonCheckBox);
        }
...
#pragma warning restore 168
        ...
        protected virtual void SetControlValue(Control control, object value, String stringValue)
        {
            ...
            KryptonComboBox cb = control as KryptonComboBox;
            if (cb != null)
            {
                if (cb.Created)
        ...
        protected virtual object GetControlValue(Control control)
        {
            ...
            KryptonComboBox comboBox = control as KryptonComboBox;
            if (comboBox != null)
                return comboBox.SelectedValue;

            KryptonCheckBox checkBox = control as KryptonCheckBox;
            if (checkBox != null)
