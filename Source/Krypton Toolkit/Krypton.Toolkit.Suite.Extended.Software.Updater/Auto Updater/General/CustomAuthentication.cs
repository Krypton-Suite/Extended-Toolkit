...
{
    /// <summary>Provides Custom Authentication header for web request.</summary>
    public class CustomAuthentication : IAuthentication
    {
        ...
        /// <inheritdoc />
        public void Apply(ref MyWebClient webClient) => webClient.Headers[HttpRequestHeader.Authorization] = ToString();

        /// <inheritdoc />
        public override string ToString() => HttpRequestHeaderAuthorizationValue;
    }
}