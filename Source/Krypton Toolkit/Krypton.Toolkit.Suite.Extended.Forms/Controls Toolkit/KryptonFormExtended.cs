...
namespace Krypton.Toolkit.Suite.Extended.Forms
{
    ...
    public class KryptonFormExtended : KryptonVirtualForm, IContentValues
    {
        ...
        public class FormButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public FormButtonSpecCollection(KryptonFormExtended owner)
                : base(owner)
            {
            }
            #endregion
        ...
        public class FormFixedButtonSpecCollection : ButtonSpecCollection<ButtonSpecFormFixed>
        {
            ...
            /// </summary>
            /// <param name="owner">Reference to owning object.</param>
            public FormFixedButtonSpecCollection(KryptonFormExtended owner)
                : base(owner)
            {
            }
            #endregion
...
#pragma warning restore CS0618
        ...
        public FormWindowState GetWindowState()
        {
            ...
            var style = PlatformInvoke.GetWindowLong(Handle, PlatformInvoke.GWL_.STYLE);

            if ((style & PlatformInvoke.WS_.MINIMIZE) != 0)
            {
                return FormWindowState.Minimized;
            }
            else
            {
                return (style & PlatformInvoke.WS_.MAXIMIZE) != 0 ? FormWindowState.Maximized : FormWindowState.Normal;
            }
        }
        ...
        {
            private readonly KryptonFormExtended _kryptonForm;

            public FormPaletteRedirect(IPalette palette, KryptonFormExtended kryptonForm)
                : base(palette) =>
        ...
        protected override IntPtr WindowChromeHitTest(Point pt, bool composition)
        {
            ...
            using (ViewLayoutContext context = new(this, Renderer))
            {
                ...
                if (_drawContent.IsImageDisplayed(context))
                {
                    ...
                    {
                        return (IntPtr)PlatformInvoke.HT.MENU;
                    }
                }
            }
        ...
        protected override bool OnWM_NCLBUTTONDOWN(ref Message m)
        {
            ...
            if (_drawContent.IsImageDisplayed(context))
            {
                ...
                if (_drawContent.ImageRectangle(context).Contains(windowPoint))
                {
                    ...
                    PlatformInvoke.PostMessage(this.Handle, PlatformInvoke.WM_.CONTEXTMENU, this.Handle, m.LParam);
                    return true;
                }
            }
