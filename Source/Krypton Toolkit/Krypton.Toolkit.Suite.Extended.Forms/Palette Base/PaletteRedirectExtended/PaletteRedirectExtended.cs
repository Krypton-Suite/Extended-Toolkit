...
namespace Krypton.Toolkit.Suite.Extended.Forms
{
    ...
    /// </summary>
    public class PaletteRedirectExtended : PaletteBase, IGlobalId
    {
        ...
        /// <summary>
        /// Initialize a new instance of the PaletteRedirectExtended class.
        /// </summary>
        /// <param name="target">Initial palette target for redirection.</param>
        /// <remarks>target can be null when performing a drag-drop operation (Amongst other usages !!)</remarks>
        public PaletteRedirectExtended(PaletteBase? target)
        {
