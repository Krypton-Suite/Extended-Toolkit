...
namespace Common.Mark.NET
{
    internal sealed class LineInfo
    {
        ...
        public int CalculateOrigin(int position, bool isStartPosition) => PositionTracker.CalculateOrigin(this.Offsets, this.OffsetCount, this.LineOffset + position, true, isStartPosition);
    }
}