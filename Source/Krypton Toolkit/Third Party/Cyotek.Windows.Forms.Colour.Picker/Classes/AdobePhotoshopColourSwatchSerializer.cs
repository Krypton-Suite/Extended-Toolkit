...
namespace Cyotek.Windows.Forms.Colour.Picker
{
    ...
    /// </summary>
    public class AdobePhotoshopColuorSwatchSerializer : PaletteSerializer
    {
        #region Properties
        ...
        public override ColourCollection Deserialize(Stream stream)
        {
        ...
        public override void Serialize(Stream stream, ColourCollection palette)
        {
            this.Serialize(stream, palette, AdobePhotoshopColourSwatchColourSpace.Rgb);
        }

        public void Serialize(Stream stream, ColourCollection palette, AdobePhotoshopColourSwatchColourSpace colorSpace)
        {
            this.Serialize(stream, palette, AdobePhotoshopColourSwatchFileVersion.Version2, colorSpace);
        }
        ...
        public void Serialize(Stream stream, ColourCollection palette, AdobePhotoshopColourSwatchFileVersion version, AdobePhotoshopColourSwatchColourSpace colorSpace)
        {
            if (stream == null)
            {
                throw new ArgumentNullException(nameof(stream));
            ...
            if (version == AdobePhotoshopColourSwatchFileVersion.Version2)
            {
                this.WritePalette(stream, palette, AdobePhotoshopColourSwatchFileVersion.Version1, colorSpace);
            }
            ...
            for (int i = 0; i < colorCount; i++)
            {
                ...
                switch (colorSpace)
                {
                    ...
                    case AdobePhotoshopColourSwatchColourSpace.Hsb:
                        ...
                        results.Add(new HslColour(hue, saturation, brightness).ToRgbColor());
                        break;
