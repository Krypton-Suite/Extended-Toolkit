...
namespace Cyotek.Windows.Forms.Colour.Picker
{
    ...
    public class ColourWheel : Control, IColourEditor
    {
        ...
        public ColourWheel()
        {
            ...
            _color = Color.Black;
            _hslColor = new HslColour(_color);
            _colorStep = 4;
            _selectionSize = 10;
            _smallChange = 1;
            _largeChange = 5;
        ...
        protected virtual void CalculateWheel()
        {
            ...
            if (size.Width > 16 && size.Height > 16)
            {
                ...
                for (double angle = 0; angle < 360; angle += _colorStep)
                {
                    ...
                    points.Add(location);
                    colors.Add(new HslColour(angle, 1, 0.5).ToRgbColor());
                }
            }
        ...
        {
            return this.GetColorLocation(new HslColour(color));
        }
        ...
        /// </summary>
        /// <param name="color">The color.</param>
        protected virtual PointF GetColorLocation(HslColour color)
        {
            double angle;
            double radius;
        ...
        protected virtual void OnColorChanged(EventArgs e)
        {
            ...
            if (!_lockUpdates)
            {
                this.HslColour = new HslColour(_color);
            }
        ...
        protected virtual void OnHslColorChanged(EventArgs e)
        {
            ...
            if (!_lockUpdates)
            {
                this.Colour = _hslColor.ToRgbColor();
            }
        ...
        protected void PaintColor(PaintEventArgs e, HslColour color)
        {
            this.PaintColor(e, color, false);
        }

        protected virtual void PaintColor(PaintEventArgs e, HslColour color, bool includeFocus)
        {
            PointF location;
        ...
        protected virtual void SetColor(Point point)
        {
            ...
            newColor = new HslColour(angle, saturation, 0.5);

            if (_hslColor != newColor)
            {
                _lockUpdates = true;
                this.HslColour = newColor;
                this.Colour = _hslColor.ToRgbColor();
                _lockUpdates = false;
            }
        }
