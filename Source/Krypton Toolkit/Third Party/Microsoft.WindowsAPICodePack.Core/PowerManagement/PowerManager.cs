namespace Microsoft.WindowsAPICodePack.Core
{
    ...
    public static class PowerManager
    {
        ...
        public static int BatteryLifePercent
        {
            get
            {
                ...
                if (!Power.GetSystemBatteryState().BatteryPresent)
                    throw new InvalidOperationException(LocalisedMessages.PowerManagerBatteryNotPresent);
        ...
        public static void SetThreadExecutionState(ExecutionStates executionStateOptions)
        {
            ...
            {
                throw new Win32Exception(LocalisedMessages.PowerExecutionStateFailed);
            }
        }
