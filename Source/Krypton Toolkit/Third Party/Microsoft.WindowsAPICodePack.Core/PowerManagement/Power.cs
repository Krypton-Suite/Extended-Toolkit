namespace Microsoft.WindowsAPICodePack.Core
{
    internal static class Power
    {
            ...
            GetSystemPowerCapabilities()
        {
            ...
            {
                throw new UnauthorizedAccessException(LocalisedMessages.PowerInsufficientAccessCapabilities);
            }
        ...
        internal static PowerManagementNativeMethods.SystemBatteryState GetSystemBatteryState()
        {
            ...
            if (retval == CoreNativeMethods.StatusAccessDenied)
            {
                throw new UnauthorizedAccessException(LocalisedMessages.PowerInsufficientAccessBatteryState);
            }
