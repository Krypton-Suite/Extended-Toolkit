namespace Microsoft.WindowsAPICodePack.Core
{
    ...
    public sealed class PropVariant : IDisposable
    {
            ...
            lock (_padlock)
            {
                ...
                if (!_cache.TryGetValue(type, out action))
                {
                    ...
                    { // if the method was not found, throw.
                        throw new ArgumentException(LocalisedMessages.PropVariantTypeNotSupported);
                    }
        ...
        public PropVariant(string value)
        {
            if (value == null)
            {
                throw new ArgumentException(LocalisedMessages.PropVariantNullString, "value");
            }
        ...
        private Array GetVector<T>()
        {
            ...
            {
                throw new InvalidCastException(LocalisedMessages.PropVariantUnsupportedType);
            }
        ...
        private static Array CrackSingleDimSafeArray(IntPtr psa)
        {
            ...
            if (cDims != 1)
                throw new ArgumentException(LocalisedMessages.PropVariantMultiDimArray, "psa");
