namespace Microsoft.WindowsAPICodePack.Core
{
    ...
    public static class ApplicationRestartRecoveryManager
    {
        ...
        public static void RegisterForApplicationRecovery(RecoverySettings settings)
        {
            ...
            if (!InternalCoreErrorHelper.Succeeded(hr))
            {
                if (hr == HResult.InvalidArguments)
                {
                    throw new ArgumentException(LocalisedMessages.ApplicationRecoveryBadParameters, "settings");
                }

                throw new ApplicationRecoveryException(LocalisedMessages.ApplicationRecoveryFailedToRegister);
            }
        }
        ...
        public static void UnregisterApplicationRecovery()
        {
            ...
            if (!InternalCoreErrorHelper.Succeeded(hr))
            {
                throw new ApplicationRecoveryException(LocalisedMessages.ApplicationRecoveryFailedToUnregister);
            }
        }
        ...
        public static void UnregisterApplicationRestart()
        {
            ...
            if (!InternalCoreErrorHelper.Succeeded(hr))
            {
                throw new ApplicationRecoveryException(LocalisedMessages.ApplicationRecoveryFailedToUnregisterForRestart);
            }
        }
        ...
        public static bool ApplicationRecoveryInProgress()
        {
            ...
            if (!InternalCoreErrorHelper.Succeeded(hr))
            {
                throw new InvalidOperationException(LocalisedMessages.ApplicationRecoveryMustBeCalledFromCallback);
            }
        ...
        public static void RegisterForApplicationRestart(RestartSettings settings)
        {
            ...
            if (hr == HResult.Fail)
            {
                throw new InvalidOperationException(LocalisedMessages.ApplicationRecoveryFailedToRegisterForRestart);
            }
            else if (hr == HResult.InvalidArguments)
            {
                throw new ArgumentException(LocalisedMessages.ApplicationRecoverFailedToRegisterForRestartBadParameters);
            }
        }
