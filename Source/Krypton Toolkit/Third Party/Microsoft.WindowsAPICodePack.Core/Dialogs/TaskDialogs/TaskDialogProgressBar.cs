    ...
    public class TaskDialogProgressBar : TaskDialogBar
    {
        ...
        public int Minimum
        {
            ...
            set
            {
                ...
                if (value < 0)
                {
                    throw new System.ArgumentException(LocalisedMessages.TaskDialogProgressBarMinValueGreaterThanZero, "value");
                }

                // Check if min / max differ
                if (value >= Maximum)
                {
                    throw new System.ArgumentException(LocalisedMessages.TaskDialogProgressBarMinValueLessThanMax, "value");
                }
        ...
        public int Maximum
        {
            ...
            set
            {
                ...
                if (value < Minimum)
                {
                    throw new System.ArgumentException(LocalisedMessages.TaskDialogProgressBarMaxValueGreaterThanMin, "value");
                }
                _maximum = value;
        ...
        public int Value
        {
            ...
            set
            {
                ...
                {
                    throw new System.ArgumentException(LocalisedMessages.TaskDialogProgressBarValueInRange, "value");
                }
                this._value = value;
