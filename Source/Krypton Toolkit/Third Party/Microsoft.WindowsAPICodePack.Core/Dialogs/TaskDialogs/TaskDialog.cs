namespace Microsoft.WindowsAPICodePack.Core
{
    ...
    public sealed class TaskDialog : IDialogControlHost, IDisposable
    {
        ...
        public IntPtr OwnerWindowHandle
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.OwnerCannotBeChanged);
                ownerWindow = value;
            }
        }
        ...
        public string Caption
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.CaptionCannotBeChanged);
                caption = value;
            }
        }
        ...
        public string FooterCheckBoxText
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.CheckBoxCannotBeChanged);
                checkBoxText = value;
            }
        }
        ...
        public bool DetailsExpanded
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.ExpandingStateCannotBeChanged);
        ...
        public string DetailsExpandedLabel
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.ExpandedLabelCannotBeChanged);
        ...
        public string DetailsCollapsedLabel
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.CollapsedTextCannotBeChanged);
        ...
        public bool Cancelable
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.CancelableCannotBeChanged);
                cancelable = value;
            }
        }
        ...
        public TaskDialogStandardButtons StandardButtons
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.StandardButtonsCannotBeChanged);
        ...
        public bool HyperlinksEnabled
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.HyperlinksCannotBetSet);
        ...
        public TaskDialogExpandedDetailsLocation ExpansionMode
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.ExpandedDetailsCannotBeChanged);
                expansionMode = value;
            }
        }
        ...
        public TaskDialogStartupLocation StartupLocation
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.StartupLocationCannotBeChanged);
        ...
        public TaskDialogProgressBar ProgressBar
        {
            ...
            set
            {
                ThrowIfDialogShowing(LocalisedMessages.ProgressBarCannotBeChanged);
                if (value != null)
                {
                    if (value.HostingDialog != null)
                    {
                        throw new InvalidOperationException(LocalisedMessages.ProgressBarCannotBeHostedInMultipleDialogs);
                    }
        ...
        private void ValidateCurrentDialogSettings()
        {
            ...
            {
                throw new InvalidOperationException(LocalisedMessages.TaskDialogCheckBoxTextRequiredToEnableCheckBox);
            }
            ...
            {
                throw new InvalidOperationException(LocalisedMessages.TaskDialogProgressBarValueInRange);
            }
            ...
            {
                throw new NotSupportedException(LocalisedMessages.TaskDialogSupportedButtonsAndLinks);
            }
            if (buttons.Count > 0 && standardButtons != TaskDialogStandardButtons.None)
            {
                throw new NotSupportedException(LocalisedMessages.TaskDialogSupportedButtonsAndButtons);
            }
        }
        ...
        public void Close()
        {
            ...
            {
                throw new InvalidOperationException(LocalisedMessages.TaskDialogCloseNonShowing);
            }
        ...
        private void ApplyControlConfiguration(NativeTaskDialogSettings settings)
        {
            ...
            if (progressBar != null)
            {
                if (progressBar.State == Core.TaskDialogProgressBarState.Marquee)
                {
        ...
        private static int FindDefaultButtonId(List<TaskDialogButtonBase> controls)
        {
            ...
            {
                throw new InvalidOperationException(LocalisedMessages.TaskDialogOnlyOneDefaultControl);
            }
        ...
        private void SortDialogControls()
        {
            foreach (TaskDialogControl control in controls)
            {
                ...
                {
                    throw new InvalidOperationException(LocalisedMessages.TaskDialogButtonTextEmpty);
                }
                ...
                {
                    throw new InvalidOperationException(LocalisedMessages.TaskDialogUnkownControl);
                }
            }
        }
        ...
        void IDialogControlHost.ApplyControlPropertyChange(string propertyName, DialogControl control)
        {
            ...
            if (NativeDialogShowing)
            {
                ...
                if (control is TaskDialogProgressBar)
                {
                    ...
                    {
                        throw new ArgumentException(LocalisedMessages.TaskDialogProgressBarValueInRange);
                    }
        ...
        internal int RaiseClosingEvent(int id)
        {
            ...
            if (handler != null)
            {
                ...
                if (buttonClicked == TaskDialogStandardButtons.None)
                {
                    ...
                    {
                        throw new InvalidOperationException(LocalisedMessages.TaskDialogBadButtonId);
                    }
        ...
        public object TaskDialogProgressBarState { get; private set; }
    }
}