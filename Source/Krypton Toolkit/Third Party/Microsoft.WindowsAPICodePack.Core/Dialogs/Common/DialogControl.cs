    ...
    public abstract class DialogControl
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException(LocalisedMessages.DialogControlNameCannotBeEmpty);
                }

                if (!string.IsNullOrEmpty(name))
                {
                    throw new InvalidOperationException(LocalisedMessages.DialogControlsCannotBeRenamed);
                }
