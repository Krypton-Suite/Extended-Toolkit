namespace Microsoft.WindowsAPICodePack.Core
{
    ...
    public static class CoreHelpers
    {
        ...
        public static void ThrowIfNotXP()
        {
            ...
            {
                throw new PlatformNotSupportedException(LocalisedMessages.CoreHelpersRunningOnXp);
            }
        }
        ...
        public static void ThrowIfNotVista()
        {
            ...
            {
                throw new PlatformNotSupportedException(LocalisedMessages.CoreHelpersRunningOnVista);
            }
        }
        ...
        public static void ThrowIfNotWin7()
        {
            ...
            {
                throw new PlatformNotSupportedException(LocalisedMessages.CoreHelpersRunningOn7);
            }
        }
