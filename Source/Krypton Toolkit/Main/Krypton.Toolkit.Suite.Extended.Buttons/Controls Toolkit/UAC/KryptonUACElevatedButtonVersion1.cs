...
namespace Krypton.Toolkit.Suite.Extended.Buttons
{
    ...
    public partial class KryptonUACElevatedButtonVersion1 : KryptonButton
    {
        ...
        private static void CaptureException(Exception exception, KryptonForm currentWindow, Control control = null, string title = @"Exception Caught", MessageBoxButtons buttons = MessageBoxButtons.OK, MessageBoxIcon icon = MessageBoxIcon.Error, string className = "", string methodSignature = "")
        {
            if (className != "")
            {
