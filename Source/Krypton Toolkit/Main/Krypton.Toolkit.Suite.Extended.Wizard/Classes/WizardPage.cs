...
{
	[Designer(typeof(WizardPageDesigner)), ToolboxItem(false)]
	public class WizardPage : KryptonPanel
	{
		...
		public int OnCloseFromBack(KryptonWizard wiz)
		{
		...
		public int OnCloseFromNext(KryptonWizard wiz)
		{
			//Event args thinks that the next pgae will be the one before this one
			PageEventArgs e = new PageEventArgs(wiz.PageIndex + 1, wiz.Pages);
			//Tell anybody who listens
		...
		/// </summary>
		/// <param name="wiz">sender</param>
		public void OnShowFromBack(KryptonWizard wiz)
		{
		...
		/// </summary>
		/// <param name="wiz">Sender</param>
		public void OnShowFromNext(KryptonWizard wiz)
		{
