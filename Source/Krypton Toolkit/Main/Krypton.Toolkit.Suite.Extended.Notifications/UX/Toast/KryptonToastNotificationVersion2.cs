...
namespace Krypton.Toolkit.Suite.Extended.Notifications
{
    ...
    public class KryptonToastNotificationVersion2 : KryptonForm, IToastNotificationUIElements
    {
        #region Design Code
        ...
        private void InitializeComponent()
        {
            ...
            this.kpnlButtons.Size = new System.Drawing.Size(670, 50);
            ...
            this.kryptonBorderEdge1.Size = new System.Drawing.Size(670, 1);
            ...
            this.kpnlContent.Size = new System.Drawing.Size(670, 299);
            this.kpnlContent.TabIndex = 1;
            // 
            // kbtnDismiss
            // 
            this.kbtnDismiss.Location = new System.Drawing.Point(480, 13);
            ...
            this.pbTimeout.Location = new System.Drawing.Point(0, 289);
            this.pbTimeout.Name = "pbTimeout";
            this.pbTimeout.Size = new System.Drawing.Size(670, 10);
            this.pbTimeout.TabIndex = 3;
            ...
            this.pbxNotificationIcon.TabIndex = 6;
            ...
            this.Resize += new System.EventHandler(this.KryptonToastNotificationVersion2_Resize);
        ...
        public KryptonToastNotificationVersion2(bool fade, Image icon, string headerText, string contentText, string dismissButtonText = "&Dismiss", bool showControlBox = false, bool showSubScript = false)
        {
            InitializeComponent();
            ...
            Resize += KryptonToastNotificationVersion2_Resize;

            GotFocus += KryptonToastNotificationVersion2_GotFocus;
        ...
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        /// <param name="showSubScript">If set to <c>true</c> show seconds subscript.</param>
        public KryptonToastNotificationVersion2(bool fade, IconType iconType, string headerText, string contentText, string dismissButtonText = "&Dismiss", bool showControlBox = false, bool showSubScript = false)
        {
            InitializeComponent();
        ...
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        /// <param name="showSubScript">If set to <c>true</c> show seconds subscript.</param>
        public KryptonToastNotificationVersion2(bool fade, Image image, string headerText, string contentText, string dismissButtonText, int seconds, bool showControlBox = false, bool showSubScript = false) : this(fade, image, headerText, contentText, dismissButtonText, showControlBox, showSubScript)
        {
            Seconds = seconds;
        ...
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        /// <param name="showSubScript">If set to <c>true</c> show seconds subscript.</param>
        public KryptonToastNotificationVersion2(bool fade, Image image, string headerText, string contentText, string dismissButtonText, int seconds, string soundPath, bool showControlBox = false, bool showSubScript = false) : this(fade, image, headerText, contentText, dismissButtonText, seconds, showControlBox, showSubScript)
        {
            SoundPath = soundPath;
        ...
        /// <param name="soundPath">The sound path.</param>
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        public KryptonToastNotificationVersion2(bool fade, Image image, string headerText, string contentText, string dismissButtonText, string soundPath, bool showControlBox = false) : this(fade, image, headerText, contentText, dismissButtonText, showControlBox)
        {
            SoundPath = soundPath;
        }
        ...
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        public KryptonToastNotificationVersion2(bool fade, Image image, string headerText, string contentText, string dismissButtonText, Stream soundStream, bool showControlBox = false) : this(fade, image, headerText, contentText, dismissButtonText, showControlBox)
        {
        ...
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        /// <param name="showSubScript">If set to <c>true</c> show seconds subscript.</param>
        public KryptonToastNotificationVersion2(bool fade, Image image, string headerText, string contentText, string dismissButtonText, int seconds, Stream soundStream, bool showControlBox = false, bool showSubScript = false) : this(fade, image, headerText, contentText, dismissButtonText, seconds, showControlBox, showSubScript)
        {
            SoundStream = soundStream;
        ...
        */
        ...
        public Panel SplitterPanel => null;
        ...
        private void KryptonToastNotificationVersion2_Resize(object sender, EventArgs e)
        {
        ...
        private void KryptonToastNotificationVersion2_GotFocus(object sender, EventArgs e) => kbtnDismiss.Focus();
#endregion
    }
}