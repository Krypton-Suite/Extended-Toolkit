...
namespace Krypton.Toolkit.Suite.Extended.Language.Model
{
    public class ButtonLanguageController
    {
        ...
        private static void AdaptButtonVisibility(ButtonType buttonType, KryptonButton okButton, KryptonButton yesButton, KryptonButton noButton, KryptonButton cancelButton, KryptonButton abortButton, KryptonButton ignoreButton, KryptonButton retryButton)
        {
