    ...
    public class ColourStringSettingsManager
    {
        ...
        */
        ...
        public void SaveColourStringSettings(bool usePrompt = false)
        {
            if (usePrompt)
            {
                DialogResult result = KryptonMessageBox.Show("Do you want to save the current colour string settings?", "Save Confirmation", MessageBoxButtons.YesNo, KryptonKryptonMessageBoxIcon.QUESTION);
        ...
        public void ResetColourStringSettings(bool usePrompt = false)
        {
            if (usePrompt)
            {
                DialogResult result = KryptonMessageBox.Show("This action will reset the colour string values. Do you want to continue?", "Reset Colour String Values", MessageBoxButtons.YesNo, KryptonKryptonMessageBoxIcon.QUESTION);
