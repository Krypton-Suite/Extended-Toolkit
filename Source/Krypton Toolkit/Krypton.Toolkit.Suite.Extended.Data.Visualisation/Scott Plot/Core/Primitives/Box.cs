    ...
    public class Box
    {
        ...
        public void Render(RenderPack rp, SKPaint paint, IAxes axes)
        {
            ...
            if (WhiskerMax.HasValue)
            {
                ...
                CoordinateLine lineMaxAcross = new(Position - CapSize / 2, WhiskerMax.Value, Position + CapSize / 2,
                    WhiskerMax.Value);
            ...
            if (WhiskerMin.HasValue)
            {
                ...
                CoordinateLine lineMinAcross = new(Position - CapSize / 2, WhiskerMin.Value, Position + CapSize / 2,
                    WhiskerMin.Value);
