namespace Krypton.Toolkit.Suite.Extended.Data.Visualisation.ScottPlot
{
    public class NumericAutomatic : ITickGenerator
    {
        ...
        private Tick[] GenerateTicks(CoordinateRange range, Edge edge, PixelLength size, PixelSize predictedTickSize,
            int depth = 0)
        {
            if (depth > 3)
            {
                DebugUtilities.WriteLine($"Warning: Tick recusion depth = {depth}");
            }
        ...
        private static Tick[] GenerateFinalTicks(double[] positions, string[] labels, CoordinateRange range,
        ...
        private static double[] MinorFromMajor(double[] majorTicks, double minorTicksPerMajorTick,
