...
public class FillY : IPlottable
{
    ...
    public FillStyle FillStyle => Poly.FillStyle;

    public LineStyle LineStyle => Poly.LineStyle;

    public MarkerStyle MarkerStyle => Poly.MarkerStyle;
    ...
    public void SetDataSource<T>(ICollection<T> items,
