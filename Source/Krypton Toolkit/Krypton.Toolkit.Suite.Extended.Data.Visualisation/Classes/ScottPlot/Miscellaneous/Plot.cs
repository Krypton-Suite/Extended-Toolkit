...
namespace Krypton.Toolkit.Suite.Extended.Data.Visualisation
{
    public class Plot
    {
        ...
        public Plot(int width = 800, int height = 600)
        {
            ...
            StyleTools.SetStyle(this, Visualisation.Style.Default);
            Resize(width, height);
            TightenLayout();
        }
        ...
        public Colourset Colourset(Colourset colorset = null)
        {
            if (colorset != null)
                settings.colourset = colorset;

            return settings.colourset;
        }
            ...
            )
        {
            ...
            fontName = Fonts.GetValidFontName(fontName);
        ...
        {
            fillColors = fillColors ?? Enumerable.Range(0, values.Length).Select(i => settings.colourset.GetColour(i)).ToArray();
        ...
        {
            if (colors is null)
                colors = Enumerable.Range(0, values.Length).Select(i => settings.colourset.GetColour(i)).ToArray();
        ...
        {
            if (fillColor == null)
                fillColor = settings.GetNextColour();
        ...
        {
            if (lineColor is null)
                lineColor = settings.GetNextColour();
            ...
            )
        {
            ...
            var plottable = new PlottablePolygons(
                    polys: polys,
                    label: label,
                    lineWidth: lineWidth,
                    lineColor: lineColor.Value,
        ...
        {
            var plottable = new PlottablePopulations(population, label, settings.GetNextColour());
            Add(plottable);
            return plottable;
        }
        ...
        {
            series.color = settings.GetNextColour();
            if (label != null)
        ...
        public PlottablePopulations PlotPopulations(PopulationMultiSeries multiSeries)
        {
            for (int i = 0; i < multiSeries.multiSeries.Length; i++)
                multiSeries.multiSeries[i].color = settings.colourset.GetColour(i);
            ...
            )
        {
            ...
            if (color != null)
                settings.ticks.colour = (Color)color;
            ...
            )
        {
            ...
            if (color != null)
            {
                settings.HorizontalGridLines.Colour = color.Value;
                settings.VerticalGridLines.Colour = color.Value;
            }
            ...
            )
        {
            ...
            if (frameColor != null)
                settings.ticks.colour = (Color)frameColor;
            if (left != null)
        ...
        */
        ...
        {
            if (figBg != null)
                settings.FigureBackground.Colour = figBg.Value;
            if (dataBg != null)
                settings.DataBackground.Colour = dataBg.Value;
            if (grid != null)
            {
                settings.HorizontalGridLines.Colour = grid.Value;
                settings.VerticalGridLines.Colour = grid.Value;
            }
            if (tick != null)
