    ...
    internal class ExceptionReportPresenter
    {
        ...
        public void SaveReportToFile(string fileName)
        {
            ...
            if (!result.Saved)
            {
                ...
                View.ShowError(ErrorReportingStrings.Unable_to_save_file + $" '{fileName}'", result.Exception);
            }
        }
        ...
        public void SendReport()
        {
            ...
            {       // most exceptions will be thrown in the Sender - this is just a backup
                ...
                View.ShowError(ErrorReportingStrings.Unable_to_setup + $" {sender.Description}" +
                               Environment.NewLine + exception.Message, exception);
            }
            finally
            {
        ...
        public void CopyReportToClipboard()
        {
            ...
            View.ProgressMessage = ErrorReportingStrings.Copied_to_clipboard;
        }
