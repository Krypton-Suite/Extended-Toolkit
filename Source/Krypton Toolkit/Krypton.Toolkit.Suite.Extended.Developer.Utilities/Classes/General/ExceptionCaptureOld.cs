...
namespace Krypton.Toolkit.Suite.Extended.Developer.Utilities
{
    ...
    public class ExceptionCapture
    {
        ...
        public void CaptureException(string exceptionMessage, bool useKryptonMessageBox = false, bool useExtendedKryptonMessageBox = false, bool useWin32MessageBox = false, bool useConsole = false, bool useToolStripLabel = false, ToolStripLabel toolStripLabel = null, object args = null, string caption = "Exception Caught", MessageBoxButtons buttons = MessageBoxButtons.OK, KryptonMessageBoxDefaultButton defaultButton = KryptonMessageBoxDefaultButton.Button3, MessageBoxDefaultButton messageBoxDefaultButton = MessageBoxDefaultButton.Button3, KryptonMessageBoxIcon icon = KryptonMessageBoxIcon.EXCLAMATION, MessageBoxOptions options = MessageBoxOptions.DefaultDesktopOnly, MessageBoxIcon winFormsBoxIcon = MessageBoxIcon.Exclamation)
        {
            ...
            {
                MessageBox.Show(exceptionMessage, caption, buttons, winFormsBoxIcon, messageBoxDefaultButton, options);
            }
            else if (useConsole)
            {
