...
namespace Toast.LTR
{
    public partial class BasicNotificationWithUserResponseConfiguration : KryptonForm
    {
        private string _soundPath;
        private Image _image;
        private Font _cueFont;

        public BasicNotificationWithUserResponseConfiguration()
        {
            InitializeComponent();
        ...
        {
            BasicNotificationWithUserResponseLTR notification = new BasicNotificationWithUserResponseLTR((IconType)Enum.Parse(typeof(IconType), kcmbNotificationIconType.Text),
