...
namespace Toast.LTR
{
    public partial class BasicNotificationWithProgressBarConfiguration : KryptonForm
    {
        private string _soundPath;
        private Image _image;

        public BasicNotificationWithProgressBarConfiguration()
        {
            InitializeComponent();
        ...
        {
            BasicNotificationWithProgressBarLTR notification = new BasicNotificationWithProgressBarLTR((IconType)Enum.Parse(typeof(IconType), kcmbNotificationIconType.Text),
