...
{
    public partial class LiveDataUpdate : KryptonForm
    {
        ...
        private void kcbRun_CheckedChanged(object sender, EventArgs e)
        {
            if (kcbRun.Checked)
            {
                sw.Start();
        ...
        private void kcbRoll_CheckedChanged(object sender, EventArgs e)
        {
