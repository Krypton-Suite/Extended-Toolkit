...
namespace Krypton.Toolkit.Suite.Extended.Buttons
{
    ...
    public class CommandLinkTextValuesVersion2 : CaptionValues
    {
        private const string _defaultHeading = @"Command Link V2";
        private const string _defaultDescription = @"Here be the ""Note Text""";

        public CommandLinkTextValuesVersion2(NeedPaintHandler needPaint)
            : base(needPaint)
        {
        }
