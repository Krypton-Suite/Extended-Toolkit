...
{
    internal partial class KryptonMessageBoxFormExtended : KryptonForm
    {
        ...
        #region Identity
        static KryptonMessageBoxFormExtended() => OS_MAJOR_VERSION = Environment.OSVersion.Version.Major;

        public KryptonMessageBoxFormExtended() => InitializeComponent();


        /// <summary>Initializes a new instance of the <see cref="KryptonMessageBoxFormExtended" /> class.</summary>
        ...
        internal KryptonMessageBoxFormExtended(IWin32Window showOwner, string text, string caption,
