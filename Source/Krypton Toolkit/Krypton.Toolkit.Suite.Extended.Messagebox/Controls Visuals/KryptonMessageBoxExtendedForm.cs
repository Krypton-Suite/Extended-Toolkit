namespace Krypton.Toolkit.Suite.Extended.Messagebox
{
	internal partial class KryptonMessageBoxExtendedForm : KryptonForm
	{
		...
		private MessageButton _buttonCopy;
											   ...
											   Color? yesNoButtonTextColour, KryptonForm parentWindow)
		{
			...
			_customButtonOptions = customButtonOptions ?? ExtendedMessageBoxCustomButtonOptions.NONE;
			...
			Load += KryptonMessageBoxExtendedForm_Load;

			FormClosing += KryptonMessageBoxExtendedForm_FormClosing;
			#endregion
		...
		#region Fade Specific
		private void KryptonMessageBoxExtendedForm_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (_fade)
			{
