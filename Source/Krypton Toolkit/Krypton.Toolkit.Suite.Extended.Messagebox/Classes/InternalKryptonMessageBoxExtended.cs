	...
	*/
	...
	internal class InternalKryptonMessageBoxExtended
	{
		...
		internal static DialogResult Show(IWin32Window owner,
										  ...
										  ExtendedKryptonMessageBoxIcon icon,
										  MessageBoxDefaultButton defaultButton, MessageBoxOptions options,
										  HelpInfo helpInformation, bool showCtrlCopy, Font messageBoxTypeface,
										  bool showOptionalCheckBox, string optionalCheckBoxText, bool isOptionalCheckBoxChecked,
										  CheckState? optionalCheckBoxCheckState,
										  AnchorStyles optionalCheckBoxAnchor, Point optionalCheckBoxLocation,
										  Image customMessageBoxIcon, bool showCopyButton = false,
		...
		#region Implementation
		private static DialogResult InternalShow(IWin32Window showOwner, string text, string caption,
											   ...
											   Color? buttonTwoTextColour, Color? buttonThreeTextColour,
											   Color? yesButtonColour, Color? noButtonColour, Color? textColour,
											   Color? yesNoButtonTextColour)
		{

		}


		#region WinForms Compatibility
											   ...
											   Color? yesNoButtonTextColour, KryptonForm parentWindow = null)
		{
			...
			using KryptonMessageBoxExtendedForm kmeb = new(showOwner, text, caption, buttons, icon, defaultButton, options, helpInfo,
														   showCtrlCopy, messageboxTypeface, showOptionalCheckBox,
														   optionalCheckBoxText, isOptionalCheckBoxChecked, optionalCheckBoxCheckState,
														   optionalCheckBoxAnchor, optionalCheckBoxLocation, customMessageBoxIcon,
														   showCopyButton, copyButtonText, fade, fadeSleepTimer, buttonOneCustomText,
														   ...
														   yesNoButtonTextColour);

			kmeb.StartPosition = showOwner == null ? FormStartPosition.CenterScreen : FormStartPosition.CenterParent;

			return kmeb.ShowDialog(showOwner);
		}
