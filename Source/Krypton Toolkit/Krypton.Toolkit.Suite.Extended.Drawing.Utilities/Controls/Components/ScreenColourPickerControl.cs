...
namespace Krypton.Toolkit.Suite.Extended.Drawing.Utilities
{
    ...
    public class ScreenColourPickerControl : Control, IColourEditor
    {
        ...
        /// </summary>
        /// <value>The colour of the grid.</value>
        [Category("Appearance")]
        ...
        /// <summary>
        /// Raises the <see cref="E:System.Windows.Forms.Control.ForeColourChanged" /> event.
        /// </summary>
        /// <param name="e">An <see cref="T:System.EventArgs" /> that contains the event data.</param>
        ...
        /// <summary>
        /// Raises the <see cref="GridColourChanged" /> event.
        /// </summary>
        /// <param name="e">The <see cref="EventArgs" /> instance containing the event data.</param>
