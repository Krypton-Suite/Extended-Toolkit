namespace Krypton.Toolkit.Suite.Extended.Networking
{
    ...
    public class KryptonNodeViewer : KryptonForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.kryptonPanel2.Size = new System.Drawing.Size(445, 140);
        ...
        private void NodeViewer_Load(object sender, EventArgs e)
        {
            ...
            {
                InternalKryptonMessageBoxExtended.Show($"An error occurred trying to access the network computers.\n\n\n{ ex.Message }", "Error",
