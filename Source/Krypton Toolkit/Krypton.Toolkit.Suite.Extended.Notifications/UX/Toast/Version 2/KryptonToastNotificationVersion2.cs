...
namespace Krypton.Toolkit.Suite.Extended.Notifications
{
    public class KryptonToastNotificationVersion2 : KryptonForm
    {
        ...
        public KryptonToastNotificationVersion2(Image image, string header, string message, Color? borderColourOne, Color? borderColourTwo, int? cornerRadius, KryptonNotificationActionButtonType? actionButtonType, KryptonNotificationActionType? actionType, bool? showActionButton, string actionButtonText, string dismissButtonText, KryptonNotificationIconType? iconType, int timeOut) : this(image, header, message, borderColourOne, borderColourTwo, cornerRadius, actionButtonType, actionType, showActionButton, actionButtonText, dismissButtonText, iconType)
        {
            TimeOut = timeOut;
        }

        public KryptonToastNotificationVersion2(Image image, string header, string message, Color? borderColourOne, Color? borderColourTwo, int? cornerRadius, KryptonNotificationActionButtonType? actionButtonType, KryptonNotificationActionType? actionType, bool? showActionButton, string actionButtonText, string dismissButtonText, KryptonNotificationIconType? iconType, int timeOut, string soundPath) : this(image, header, message, borderColourOne, borderColourTwo, cornerRadius, actionButtonType, actionType, showActionButton, actionButtonText, dismissButtonText, iconType, timeOut)
        {
            SoundPath = soundPath;
        }
        ...
        public KryptonToastNotificationVersion2(Image image, string header, string message, Color? borderColourOne, Color? borderColourTwo, int? cornerRadius, KryptonNotificationActionButtonType? actionButtonType, KryptonNotificationActionType? actionType, bool? showActionButton, string actionButtonText, string dismissButtonText, KryptonNotificationIconType? iconType, int timeOut, Stream soundStream) : this(image, header, message, borderColourOne, borderColourTwo, cornerRadius, actionButtonType, actionType, showActionButton, actionButtonText, dismissButtonText, iconType, timeOut)
        {
            SoundStream = soundStream;
        }
        #endregion
