...
{
    public class KryptonToastWindowVersion3 : KryptonForm, IToastNotificationUIElements
    {
        #region Design Code
        ...
        private void InitializeComponent()
        {
            ...
            this.kpnlButtons.Location = new System.Drawing.Point(0, 267);
            ...
            // kpnlContent
            // 
            this.kpnlContent.Controls.Add(this.ktxtResponse);
            this.kpnlContent.Controls.Add(this.pbTickDown);
            ...
            // ktxtResponse
            // 
            this.ktxtResponse.CueHint.CueHintText = "Enter response here...";
            this.ktxtResponse.CueHint.Padding = new System.Windows.Forms.Padding(0);
            this.ktxtResponse.CueHint.TextH = Krypton.Toolkit.PaletteRelativeAlign.Center;
            this.ktxtResponse.Location = new System.Drawing.Point(145, 234);
            this.ktxtResponse.Name = "ktxtResponse";
            this.ktxtResponse.ReadOnly = true;
            this.ktxtResponse.Size = new System.Drawing.Size(450, 23);
            this.ktxtResponse.TabIndex = 5;
            this.ktxtResponse.Visible = false;
            // 
        ...
        private string _headerText, _contentText, _processName, _actionButtonLaunchProcessText, _actionButtonOpenText, _responseCueText, _responseText;
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="KryptonToastWindowVersion3"/> is fade.
        /// </summary>
        /// <value>
        ...
        public string ResponseCueText { get => _responseCueText; set => _responseCueText = value; }

        public string ResponseText { get => _responseText; set => _responseText = value; }
        #endregion
        ...
        #region Constructors
        /// <summary>Initializes a new instance of the <see cref="KryptonToastWindowVersion3" /> class.</summary>
        ...
        public KryptonToastWindowVersion3(bool fade, Image icon, string headerText, string contentText, bool showControlBox = true,
                                          bool showProgressBar = false)
        {
            ...
            Resize += KryptonToastWindowVersion3_Resize;

            GotFocus += KryptonToastWindowVersion3_GotFocus;
        ...
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        /// <param name="showProgressBar">if set to <c>true</c> [show progress bar].</param>
        public KryptonToastWindowVersion3(bool fade, IconType iconType, string headerText, string contentText,
        ...
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        /// <param name="showProgressBar">if set to <c>true</c> [show progress bar].</param>
        public KryptonToastWindowVersion3(bool fade, Image image, string headerText, string contentText, int seconds, bool showControlBox = true,
                                          bool showProgressBar = false) :
        ...
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        /// <param name="showProgressBar">if set to <c>true</c> [show progress bar].</param>
        public KryptonToastWindowVersion3(bool fade, Image image, string headerText, string contentText, int seconds,
        ...
        /// <param name="showProgressBar">if set to <c>true</c> [show progress bar].</param>
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        public KryptonToastWindowVersion3(bool fade, Image image, string headerText, string contentText, string soundPath, bool showProgressBar = true,
        ...
        /// <param name="showProgressBar">if set to <c>true</c> [show progress bar].</param>
        /// <param name="showControlBox">if set to <c>true</c> [show control box].</param>
        public KryptonToastWindowVersion3(bool fade, Image image, string headerText, string contentText, Stream soundStream, bool showProgressBar = true,
                                          bool showControlBox = true) :
                                          this(fade, image, headerText, contentText, showControlBox, showProgressBar)
        {
        ...
        public KryptonToastWindowVersion3(bool fade, Image image, string headerText, string contentText,
        ...
        public KryptonToastWindowVersion3(bool fade, Image image, string headerText, string contentText,
                                          ...
                                          bool showProgressBar = false, float cornerRadius = -1, string actionButtonLaunchProcessText = "&Launch Process",
                                          string actionButtonOpenText = "&Open") :
        ...
        public KryptonToastWindowVersion3(bool fade, Image image, string headerText, string contentText,
                                          ...
                                          bool showControlBox = true, string actionButtonLaunchProcessText = "&Launch Process", 
                                          string actionButtonOpenText = "&Open", float cornerRadius = -1, 
                                          PaletteDrawBorders borders = PaletteDrawBorders.All,
        ...
        public string GetResponseText() => ResponseText;
        #endregion
        ...
        private void kbtnDismiss_Click(object sender, EventArgs e) => FadeOutAndClose();

        private void KryptonToastWindowVersion3_Resize(object sender, EventArgs e)
        {
        ...
        private void KryptonToastWindowVersion3_GotFocus(object sender, EventArgs e) => kbtnDismiss.Focus();

        private void KryptonToastWindowVersion3_Load(object sender, EventArgs e)
        {
            // Bottom left
        ...
        public KryptonButton ActionButton { get => kbtnAction; }
