...
{
    public class CustomFormatRuleOld : KryptonForm
    {
        #region Design Code
        ...
        {
            ComponentResourceManager resources = new(typeof(CustomFormatRuleOld));
            _kryptonPanel1 = new();
            _kbtnOk = new();
            _kbtnCancel = new();
            ...
            _kbtnOk.Click += new(kbtnOk_Click);
            // 
            // kbtnCancel
            // 
            ...
            _kbtnCancel.Click += new(kbtnCancel_Click);
            // 
            // kryptonBorderEdge1
            // 
            ...
            _kcmbFillMode.SelectedIndexChanged += new(kcmbFillMode_SelectedIndexChanged);
            // 
            // klblFill
            // 
            ...
            _kcbMaxColour.SelectedColorChanged += new(kcbMaxColour_SelectedColorChanged);
            // 
            // kcbMediumColour
            // 
            ...
            _kcbMediumColour.SelectedColorChanged += new(kcbMediumColour_SelectedColorChanged);
            // 
            // kcbMinColour
            // 
            ...
            _kcbMinColour.SelectedColorChanged += new(kcbMinColour_SelectedColorChanged);
            // 
            // pbxPreview
            // 
            ...
            _pbxPreview.Paint += new(pbxPreview_Paint);
            // 
            // klblPreview
            // 
            ...
            _kcmbStyle.SelectedIndexChanged += new(kcmbStyle_SelectedIndexChanged);
            // 
            // klblFormat
            // 
            ...
            Text = "Custom Rule";
            Load += new(CustomFormatRule_Load);
        ...
        #region Constructors
        public CustomFormatRuleOld(EnumConditionalFormatType initialFormatType)
        {
            InitializeComponent();
