namespace Krypton.Toolkit.Suite.Extended.TaskDialogs
{
    /// <summary>
    ...
    public class VisualTaskDialog : KryptonForm
    {
        ...
        #region Instance Fields
        private KryptonTaskDialogExtended _taskDialog;
        ...
        private KryptonTaskDialogCommandExtended _defaultRadioButton;
        ...
        public VisualTaskDialog(KryptonTaskDialogExtended taskDialog)
        {
            ...
            else
            {
                switch (_mainIcon)
                {
                    ...
                    case KryptonMessageBoxIcon.Hand:
                        _messageIcon.Image = Properties.Resources.HandSmall;
                        SystemSounds.Hand.Play();
                        break;
                    case KryptonMessageBoxIcon.Question:
                        _messageIcon.Image = Properties.Resources.QuestionSmall;
                        SystemSounds.Question.Play();
                        break;
                    case KryptonMessageBoxIcon.Exclamation:
                        _messageIcon.Image = Properties.Resources.WarningSmall;
                        SystemSounds.Exclamation.Play();
                        break;
                    case KryptonMessageBoxIcon.Asterisk:
                        _messageIcon.Image = Properties.Resources.AsteriskSmall;
                        SystemSounds.Asterisk.Play();
                        break;
                    case KryptonMessageBoxIcon.Stop:
                        _messageIcon.Image = Properties.Resources.StopSmall;
                        SystemSounds.Asterisk.Play();
                        break;
                    case KryptonMessageBoxIcon.Information:
                        _messageIcon.Image = Properties.Resources.InformationSmall;
                        SystemSounds.Asterisk.Play();
                        break;
                    ...
                    case KryptonMessageBoxIcon.Error:
                        _messageIcon.Image = Properties.Resources.CriticalSmall;
                        SystemSounds.Hand.Play();
                        break;
                    ...
                    case KryptonMessageBoxIcon.WindowsLogo:
                        ...
                        {
                            _messageIcon.Image = Properties.Resources.Windows_11_Small;
                        }
                        // Windows 10
                        else if (Environment.OSVersion.Version.Major == 10 && Environment.OSVersion.Version.Build <= 19044 /* RTM - 21H2 */)
                        {
                            _messageIcon.Image = Properties.Resources.Windows_8_and_10_Logo_Small;
                        }
                        else
                        {
        ...
        private void UpdateRadioButtons()
        {
            ...
            else
            {
                ...
                foreach (KryptonTaskDialogCommandExtended command in _radioButtons)
                {
        ...
        private void UpdateCommandButtons()
        {
            ...
            else
            {
                ...
                Size maxButtonSize = Size.Empty;
                foreach (KryptonTaskDialogCommandExtended command in _commandButtons)
                {
            ...
            else
            {
                ...
                switch (_footerIcon)
                {
                    case KryptonMessageBoxIcon.None:
                        ...
                        break;
                    case KryptonMessageBoxIcon.Question:
                        _iconFooter.Image = Properties.Resources.Question;
                        break;
                    case KryptonMessageBoxIcon.Information:
                        _iconFooter.Image = Properties.Resources.Information;
                        break;
                    case KryptonMessageBoxIcon.Warning:
                        _iconFooter.Image = Properties.Resources.Warning;
                        break;
                    case KryptonMessageBoxIcon.Error:
                        _iconFooter.Image = Properties.Resources.Critical;
                        break;
                    case KryptonMessageBoxIcon.Hand:
                        _iconFooter.Image = Properties.Resources.Hand;
                        break;
                    case KryptonMessageBoxIcon.Exclamation:
                        _iconFooter.Image = Properties.Resources.Warning;
                        break;
                    case KryptonMessageBoxIcon.Asterisk:
                        _iconFooter.Image = Properties.Resources.Asterisk;
                        break;
                    case KryptonMessageBoxIcon.Stop:
                        _iconFooter.Image = Properties.Resources.Stop;
                        break;
                    case KryptonMessageBoxIcon.Shield:
                    ...
                    case KryptonMessageBoxIcon.WindowsLogo:
                        ...
                        if (Environment.OSVersion.Version.Major >= 10 && Environment.OSVersion.Version.Build >= 22000)
                        {
                            _iconFooter.Image = Properties.Resources.Windows11;
                        }
                        // Windows 10
                        else if (Environment.OSVersion.Version.Major == 10 && Environment.OSVersion.Version.Build <= 19044 /* RTM - 21H2 */)
                        {
                            _iconFooter.Image = Properties.Resources.Windows_8_and_10_Logo;
                        }
                        else
                        {
        ...
        private void OnRadioButtonCheckedChanged(object sender, EventArgs e)
        {
            ...
            _defaultRadioButton = (KryptonTaskDialogCommandExtended)button.Tag;
        ...
        private void OnCommandClicked(object sender, EventArgs e)
        {
            ...
            KryptonTaskDialogCommandExtended command = (KryptonTaskDialogCommandExtended)button.Tag;
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        private void InitializeComponent()
        {
            ...
            this._buttonOK = new Krypton.Toolkit.Suite.Extended.TaskDialogs.VisualTaskDialog.MessageButton();
            this._buttonYes = new Krypton.Toolkit.Suite.Extended.TaskDialogs.VisualTaskDialog.MessageButton();
            this._buttonNo = new Krypton.Toolkit.Suite.Extended.TaskDialogs.VisualTaskDialog.MessageButton();
            this._buttonRetry = new Krypton.Toolkit.Suite.Extended.TaskDialogs.VisualTaskDialog.MessageButton();
            this._buttonCancel = new Krypton.Toolkit.Suite.Extended.TaskDialogs.VisualTaskDialog.MessageButton();
            this._buttonClose = new Krypton.Toolkit.Suite.Extended.TaskDialogs.VisualTaskDialog.MessageButton();
