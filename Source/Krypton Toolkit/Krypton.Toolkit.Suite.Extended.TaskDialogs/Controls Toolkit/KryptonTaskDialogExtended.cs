namespace Krypton.Toolkit.Suite.Extended.TaskDialogs
{
    ...
    /// </summary>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(KryptonTaskDialogExtended), "ToolboxBitmaps.KryptonTaskDialog.bmp")]
    [DefaultEvent("PropertyChanged")]
    [DesignerCategory(@"code")]
    [Description(@"Displays a task dialog for presenting different options to the user.")]
    public class KryptonTaskDialogExtended : Component, INotifyPropertyChanged
    {
        ...
        /// </summary>
        public KryptonTaskDialogExtended()
        {
        ...
        public KryptonTaskDialogCommandExtended DefaultRadioButton
        {
                                        ...
                                        TaskDialogButtons commonButtons)
        {
            ...
            using KryptonTaskDialogExtended taskDialog = new();
