namespace Krypton.Toolkit.Suite.Extended.TaskDialogs
{
    ...
    public class KryptonTaskDialogCommandExtended : Component, IKryptonCommand, INotifyPropertyChanged
    {
        ...
        /// </summary>
        public KryptonTaskDialogCommandExtended()
        {
            _enabled = true;
            _text = string.Empty;
    ...
    /// </summary>
    public class KryptonTaskDialogCommandCollection : TypedCollection<KryptonTaskDialogCommandExtended>
    {
        #region Public
        /// <summary>
        ...
        public override KryptonTaskDialogCommandExtended this[string name]
        {
            get
            {
                if (!string.IsNullOrEmpty(name))
                {
                    foreach (KryptonTaskDialogCommandExtended item in this)
                    {
                        var text = item.Text;
