...
namespace Krypton.Toolkit.Suite.Extended.Core
{
    ...
    public class ColourWheelControl : Control, IColourEditor
    {
        ...
        [Category("Appearance")]
        [DefaultValue(typeof(HSLColourStructure), "0, 0, 0")]
        ...
        protected virtual void CalculateWheel()
        {
            ...
            if (size.Width > 16 && size.Height > 16)
            {
                ...
                for (double angle = 0; angle < 360; angle += _colourStep)
                {
                    ...
                    points.Add(location);
                    colors.Add(new HSLColourStructure(angle, 1, 0.5).ToRgbColour());
                }
            }
        ...
        {
            return this.GetColourLocation(new HSLColourStructure(colour));
        }
